...
# CSV
rio_csv <- import("D:/R_Coding/R_Course_contents/ImportingData_Datasets/mbb.csv")
head(rio_csv)

# TXT
rio_txt <- import("D:/R_Coding/R_Course_contents/ImportingData_Datasets/mbb.xlsx")
head(rio_txt)

# Excel XLSX
rio_xlsx <- import("D:/R_Coding/R_Course_contents/ImportingData_Datasets/mbb.xlsx")
head(rio_xlsx)
...
# complete data.
r_txt1 <- read.table("D:/R_Coding/R_Course_contents/ImportingData_Datasets/mbb.xlsx",
                     header = TRUE)

# This works with missing data by specifying the separator: 
# \t is for tabs, sep = "," for commas. R converts missing
# to "NA"
r_txt2 <- read.table("D:/R_Coding/R_Course_contents/ImportingData_Datasets/mbb.xlsx", 
  header = TRUE,
  sep = "\t")
